        ...
        if (studentIndex!=-1){
            ...
            if (b!= null){
                ...
                if (theStudents[studentIndex].booksCount<=3){
                    ...
                    theStudents[studentIndex].borrowBooks[theStudents[studentIndex].booksCount] = b;
    ...
    public void checkInBook(books book){
        ...
        if (studentIndex != -1){
            ...
            for (int i=0; i<s.booksCount; i++){
                ...
                System.out.println(s.borrowBooks[i].sNo+ "\t\t\t" + s.borrowBooks[i].bookName + "\t\t\t"+
                        s.borrowBooks[i].authorName);
            ...
            for (int i=0; i<s.booksCount; i++){
                ...
                if (sNo == s.borrowBooks[i].sNo){

                    book.checkInBook(s.borrowBooks[i]);
                    s.borrowBooks[i]=null;
                    return;
